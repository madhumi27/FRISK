...
console.log(obj);
  ...
  return (
    ...
    <Link to='/Signup'>
    <Button variant="contained"style={{color:"black",border:"solid",paddingRight:"10px"}}>Sign Up</Button>
    </Link>
    </div>
   ...
   <Link to='/land'>
    <Button variant="outlined" type="submit" style={{color:"black",border:"solid",paddingRight:"10px"}} >Continue</Button>
    </Link>
    </form>
    ...
    <Button variant="outlined" style={{color:"black",border:"solid",paddingRight:"10px"}} >Log In with FaceBook</Button>
